...
Model performance on test data using pretrained checkpoints:

| Model Configuration | Input Images | Mean Distance Error | Accuracy |
| ------------------- | ------------ | ------------------- | -------- |
| SVCNN RGBD | 72 (all directions) | 0.145 | 85.2% |
| SVCNN RGBD | 36 (front only) | 0.187 | 81.3% |
| SVCNN RGBD | 3 (minimal set) | 0.234 | 76.1% |
| ViewGCN Ensemble | 72 (all directions) | 0.128 | 87.6% |
| ViewGCN Ensemble | 36 (front only) | 0.169 | 83.8% |
| ViewGCN Ensemble | 3 (minimal set) | 0.218 | 78.4% |

Performance metrics demonstrate effectiveness across different input configurations, with best results achieved using the full 72-image capture set.
